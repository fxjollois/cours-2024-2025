...
> La distribution semble unimodale (un seul *pic*) mais pas totale symétrique.
...
```{r qqplot}
qqnorm(tips$total_bill) # représentation des observés
qqline(tips$total_bill) # affichage de la droite, représentant la "normalité"
```
